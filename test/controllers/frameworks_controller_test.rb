...
class FrameworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create framework" do
    assert_difference("Framework.count") do
      post frameworks_url, params: { framework: { mycode: @framework.mycode, mylogincode: @framework.mylogincode, myroutecode: @framework.myroutecode, name: @framework.name } }
    end
  ...
  test "should update framework" do
    patch framework_url(@framework), params: { framework: { mycode: @framework.mycode, mylogincode: @framework.mylogincode, myroutecode: @framework.myroutecode, name: @framework.name } }
