class FrameworksController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @framework.update(framework_params)
        format.html { redirect_to @framework, notice: "Framework was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to frameworks_path, notice: "Framework was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def framework_params
      params.expect(framework: [ :name, :mycode, :mylogincode, :myroutecode ])
    end
end
